            ...
            <div className="relative z-10 flex h-full flex-col">
              ...
              <div className="mt-16 max-w-[430px]">
                ...
                <p className="mt-6 max-w-[390px] text-[12px] leading-5 text-[#45647f]">
                  Create examinations, manage questions, monitor students
                  and review results through one intelligent platform.
                </p>
            ...
            <div className="mx-auto w-full max-w-[370px]">
              ...
              <div className="mb-8">
                ...
                <p className="mt-3 text-[11px] leading-5 text-slate-500">
                  Sign in to access your ExamAI teacher dashboard.
                </p>
              </div>
