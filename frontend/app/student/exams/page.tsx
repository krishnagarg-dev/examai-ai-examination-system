                    ...
                    <nav className="mt-[14px] space-y-[8px]">
                        {navItems.map((item) => (
                            <Link
                                key={item.label}
                                href={item.href}
                                className={`flex items-center gap-[17px] rounded-[14px] px-[18px] py-[16px] text-[14px] font-medium transition-all ${pathname === item.href
                        ...
                        <div className="space-y-[16px]">
                            {upcomingExams.map((exam) => (
                                ...
                                >
                                    ...
                                    <Link
                                        href={`/student/exams/${exam.code.toLowerCase()}`}
                                        className="rounded-[13px] bg-[#63a8b9] px-[22px] py-[12px] text-[13px] font-semibold text-white transition hover:opacity-90"
                                    >
                                        View Details
                                    </Link>
                                </div>
                    ...
                    <div className="mt-[28px] rounded-[22px] border border-[#e8eaf0] bg-white p-[26px]">
                        ...
                        <div className="space-y-[14px]">
                            {completedExams.map((exam) => (
                                <div
                                    key={exam.code}
                                    className="flex items-center justify-between rounded-[16px] border border-[#eef0f4] p-[18px]"
                                >
                                    <div>
                                    ...
                                    <div className="text-right">
                                        <p className="text-[19px] font-bold text-[#63a8b9]">
                                            {exam.score}
                                        </p>
